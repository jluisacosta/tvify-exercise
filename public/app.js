...
var $loader = (0, _jquery2.default)('<div class="loader">Loading...</div>'); /**
                                                                              * Module Dependencies
                                                                              */
...
(0, _page2.default)('/search', function (context, next) {
    ...
    var searchText = _qs2.default.parse(context.querystring);

    (0, _tvmazeApiClient.searchShows)(searchText, function (response) {
        ...
        if (shows.length > 0) {
            ...
            $loader.remove();
            _tvShowsContainer2.default.append($searchMsg);
        }
    });
});
...
function renderShows(shows) {
    ...
    shows.forEach(function (show) {
        var $tvShow = (0, _jquery2.default)(tvShowTemplate.replace(':img:', show.image ? show.image.medium : 'http://promovie.info/img/films/not_found.jpg').replace(':img alt:', show.name + " Logo").replace(':name:', show.name).replace(':summary:', show.summary));

        $tvShow.hide();
        _tvShowsContainer2.default.append($tvShow);
        $tvShow.fadeIn(2000);
    });
}
...
var $tvShowsDiv = (0, _jquery2.default)('#app-body').find('.tv-shows'); /**
                                                                         * Module Dependencies
                                                                         */
...
function searchShows(searchText, callback) {
